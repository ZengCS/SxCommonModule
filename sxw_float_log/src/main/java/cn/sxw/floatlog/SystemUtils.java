        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (usm != null) {
                ...
                List<UsageStats> stats = usm.queryUsageStats(UsageStatsManager.INTERVAL_BEST,
                        now - 30 * 1000, now);
                Log.i("KeTang/Student", "Running app number in last 30 seconds : " + stats.size());
                for (UsageStats us : stats) {
                    Log.i("KeTang/Student", "Running app : " + us.getPackageName());
                }
                ...
                Log.i("KeTang/Student", "top running app is : " + topAppPackage);
            }
